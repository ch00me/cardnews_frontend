...
const Component1 = () => {
  ...
  return (
    <div className={styles.div} data-scroll-to="container1">
      ...
      <img className={styles.icon} alt="" src="/0011@2x.png" />
      <img className={styles.child} alt="" src="/group-1.svg" />
      <div className={styles.div1}>화면을 옆으로 넘겨주세요.</div>
      ...
      <div className={styles.rectangleParent} onClick={onGroupContainer5Click}>
